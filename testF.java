	...
	if(line._model_variable_name=="sERIES9UIATO")
	   {
		...
		//sehQty = 1;
		phQty = 1;
		if(isnumber(getconfigattrvalue(line._document_number, "Ui_pHQuantity"))){
			//sehQty = atoi(getconfigattrvalue(line._document_number, "Ui_pHQuantity"));
			phQty = atoi(getconfigattrvalue(line._document_number, "Ui_pHQuantity"));
		}
		...
		if(enclosureOptions <> "" AND enclosureOptions <> "None" AND  NOT(isnull(enclosureOptions))){
			//powerhub=powerhub+quantity*sehQty;
			powerhub=powerhub+quantity*phQty;
	    }
	    ...
	    if(otconfiguration <> "" AND otconfiguration <> "None" AND  NOT(isnull(otconfiguration))){
	    ...
	    if(gCPConfiguration <> "" AND gCPConfiguration <> "None" AND  NOT(isnull(gCPConfiguration))){
	    ...
	    if(gCIConfiguration <> "" AND gCIConfiguration <> "None" AND  NOT(isnull(gCIConfiguration))){
